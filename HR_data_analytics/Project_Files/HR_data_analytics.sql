...
DESCRIBE hr;   -- Data types in the table
...
SELECT race,gender,count(*) AS count FROM hr WHERE age>=18 AND termdate='0000-00-00' GROUP BY race,gender ORDER BY race,gender DESC;
...
SELECT 
	...
	END AS age_group,
    COUNT(*) AS count
FROM hr WHERE age>=18 AND termdate='0000-00-00' GROUP BY age_group ORDER BY age_group;
...
SELECT location,gender,COUNT(*) AS count FROM hr WHERE age>=18 AND termdate='0000-00-00' GROUP BY location,gender ORDER BY location;
...
SELECT department,COUNT(*) AS count FROM hr WHERE age>=18 AND termdate='0000-00-00'
GROUP BY department ORDER BY count;

SELECT gender,COUNT(*) AS terminated_employees FROM hr WHERE age>=18 AND termdate<>'0000-00-00' GROUP BY gender;